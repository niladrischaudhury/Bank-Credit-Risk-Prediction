...
from banking.util.util import load_numpy_array_data,save_object,load_object
from banking.entity.model_factory import MetricInfoArtifact, ModelFactory,GridSearchedBestModel
from banking.entity.model_factory import evaluate_regression_model

class BankingEstimatorModel:
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            housing_model = BankingEstimatorModel(preprocessing_object=preprocessing_obj,trained_model_object=model_object)
