...
class Configuartion:
    ...
    def get_data_ingestion_config(self) ->DataIngestionConfig:
        try:
            ...
            extract_download_dir = os.path.join(
                data_ingestion_artifact_dir,
                data_ingestion_info[DATA_INGESTION_ZIP_DATA_DIR_KEY]
            )
            main_data_dir = os.path.join(data_ingestion_artifact_dir,
            data_ingestion_info[DATA_INGESTION_UNZIP_DOWNLOAD_DIR_KEY]
            )
            ...
            data_ingestion_config=DataIngestionConfig(
                ...
                extract_download_dir=extract_download_dir, 
